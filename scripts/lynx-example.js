...
// const isPackCopy = process.env.PACK_COPY === 'yes';
// const isPackCopy = process.env.npm_lifecycle_event === 'prepack';
// const isPackCopy = process.argv.includes('--pack-copy');
// const isPackCopy = process.env.LN_COPY !== 'yes';
